...
| `GetSprefValue` | L2456 | 활성 |
| `ParseOrientation` | L2674 | 활성 |
| `GetMfgOrientationAxisVector` | L3061 | 활성 ReferenceAxis와 같은 로컬 X/Y/Z 축 벡터를 UserAxis 치수용 `Vertex3D`로 반환 |
| `DetectMfgAxis` | L3161 | ORIENTATION 부재 시 사용할 LINE Osnap 5도 방향군·길이 합 폴백 판정 |
| `LogMfgAxisDetection` | L3255 | ORIENTATION 우선 최종 판정과 기하 대조 결과 진단 로그 |
