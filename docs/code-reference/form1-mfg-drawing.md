...
**경로**: `A2Z/Form1.MfgDrawing.cs` (약 2,344 라인)
...
| 핸들러 | 라인 | 흐름 문서 |
|---|---:|---|
| <a id="btnMfgDrawingSheet_Click"></a>`btnMfgDrawingSheet_Click` | L1684 | [가공도 시트 PDF 출력](../기능/가공도/가공도%20시트.md) |
...
- LINE/POINT Osnap 수집, 뒷면 필터, 체인 치수, 보조선을 생성한다.
...
| `GenerateMfgDrawing2DAll` | L1741 | 구형 그리드 출력, 현재 호출자 없음 |
| `RenderMfgViewForDrawing` | L1935 | 구형 그리드 셀 렌더, 현재 호출자 없음 |
| `ParseOrientation` | L2268 | 활성 |
