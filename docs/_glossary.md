...
→ 추출 임계값·필터링 사양: [Osnap 기준](./기술%20노트/Osnap%20기준.md)
...
→ 텍스트 위치·시프트 규칙: [치수 텍스트 위치](./기술%20노트/치수%20텍스트%20위치.md)
...
### 보조선
치수선 끝과 부재 표면을 잇는 가는 선 (Extension Line). 풍선과 부재를 잇는 지시선(Leader)도 통상 같이 부름.
→ 선 종류·gap·굵기·길이 통합 사양: [치수 보조선 사양](./기술%20노트/치수%20보조선%20사양.md)
...
→ Sheet1 기준부재 이름 부여 규칙: [Sheet1 명명 기준](./기술%20노트/Sheet1%20명명%20기준.md)
