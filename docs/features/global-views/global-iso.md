...
## 8. 후행 기능 (Chained)
- [풍선 위치 조정](../dimensions/balloon-adjust.md)
- [X/Y/Z 축 뷰](./global-axis-x.md)

## 9. 관련 링크
- 코드 구현: [Form1.GlobalViews.cs:L17](/docs/code-reference/form1-global-views.md#btnGlobalISO_Click)
