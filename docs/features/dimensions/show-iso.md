...
## 5. 주요 분기 처리
[X축 뷰](./show-axis-x.md)와 동일하되, "ISO"인 경우 풍선 생성 경로로 분기.
...
## 8. 후행 기능 (Chained)
- [풍선 위치 조정](./balloon-adjust.md)

## 9. 관련 링크
- 코드 구현: [Form1.Dimensions.cs:L230](/docs/code-reference/form1-dimensions.md#btnShowISO_Click)
