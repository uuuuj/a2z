...
내부 흐름은 [X축 뷰 문서](./show-axis-x.md) 및 [공용 ApplyGlobalView](../global-views/_index.md) 참고.

## 5. 주요 분기 처리
[X축 뷰](./show-axis-x.md)와 동일 (축만 다름).
...
## 9. 관련 링크
- 코드 구현: [Form1.Dimensions.cs:L214](/docs/code-reference/form1-dimensions.md#btnShowAxisY_Click)
