...
## 1. 개요
선택 시트를 Z축 방향으로 표시. 공용 `ApplyDrawingSheetView("Z")` 호출. 세부는 [X축 뷰](./drawing-axis-x.md) 참고.
...
## 9. 관련 링크
- 코드 구현: [Form1.DrawingSheets.cs:L770](/docs/code-reference/form1-drawing-sheets.md#btnDrawingAxisZ_Click)
