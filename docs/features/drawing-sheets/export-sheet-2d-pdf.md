...
## 1. 개요
선택된 시트의 2D 도면을 벡터 PDF로 저장한다. 동작은 [Drawing2D의 PDF 내보내기](../drawing2d/export-pdf.md)와 동일(파일명 prefix만 `Sheet2D_`).
...
## 8. 후행 기능 (Chained)
- 다른 시트 반복
- [전체 PDF 배치](./export-all-pdf.md)

## 9. 관련 링크
- 코드 구현: [Form1.DrawingSheets.cs:L806](/docs/code-reference/form1-drawing-sheets.md#btnExportSheet2DPDF_Click)
