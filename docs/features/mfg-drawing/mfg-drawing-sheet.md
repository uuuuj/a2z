...
## 8. 후행 기능 (Chained)
- [선택 시트 PDF](../drawing-sheets/export-sheet-2d-pdf.md)
- [전체 PDF 배치](../drawing-sheets/export-all-pdf.md)

## 9. 관련 링크
- 코드 구현: [Form1.MfgDrawing.cs:L548](/docs/code-reference/form1-mfg-drawing.md#btnMfgDrawingSheet_Click), [GenerateMfgDrawing2DAll](/docs/code-reference/form1-mfg-drawing.md#GenerateMfgDrawing2DAll)
