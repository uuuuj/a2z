...
> 구현 상세는 [코드 레퍼런스](/docs/code-reference/form1-drawing2d.md#btnExportPDF_Click) 참고
...
## 9. 관련 링크
- 코드 구현: [Form1.Drawing2D.cs:L82](/docs/code-reference/form1-drawing2d.md#btnExportPDF_Click)
- 선행: [전체 2D 생성](./generate-2d.md)
