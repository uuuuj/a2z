...
> 픽킹 발생 시 동작은 [Osnap 픽킹 이벤트](./osnap-picking-event.md) 참고
...
## 8. 후행 기능 (Chained)
- [Osnap 픽킹 이벤트](./osnap-picking-event.md) — 사용자 클릭 시마다 호출

## 9. 관련 링크
- 코드 구현: [Form1.Drawing2D.cs:L694](/docs/code-reference/form1-drawing2d.md#btnOsnapAdd_Click)
