...
> 구현 상세는 [코드 레퍼런스](/docs/code-reference/form1-clash.md#CollectBOMInfo) 참고
...
## 8. 후행 기능 (Chained)
- [시트별 2D 생성](../drawing-sheets/generate-sheet-2d.md) — 내부적으로 `CollectBOMInfo(false, sheet)` 호출

## 9. 관련 링크
- 코드 구현: [Form1.Clash.cs:L15](/docs/code-reference/form1-clash.md#btnCollectBOMInfo_Click)
