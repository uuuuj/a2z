...
- [BOM 수집](./collect-bom.md)
- [메인 치수 추출](./main-dimension.md)
- [글로벌 뷰 전환](../global-views/_index.md)

## 9. 관련 링크
- 코드 구현: [Form1.BOM.cs](/docs/code-reference/form1-bom.md#btnResetToInitial_Click)
- 대비 참고: [모델 파일 열기](./open-model.md) (초기화 블록이 거의 동일하되 파일 다이얼로그 포함)
