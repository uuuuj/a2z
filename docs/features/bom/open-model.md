...
## 3. 사전 조건
- [ ] VIZCore3D 초기화 완료 ([BOM-001](./vizcore3d-initialized.md))
- [ ] 라이선스 유효
...
- [속성 조회](../attribute/object-selected-event.md)

## 9. 관련 링크
- 코드 구현: [Form1.BOM.cs:L209](/docs/code-reference/form1-bom.md#btnOpen_Click)
