...
## 8. 후행 기능 (Chained)
- [속성 CSV 내보내기](./export-csv.md) — 백업/공유

## 9. 관련 링크
- 코드 구현: [Form1.Attribute.cs:L485](/docs/code-reference/form1-attribute.md#btnUdaImportCSV_Click), [ParseCsvLine](/docs/code-reference/form1-attribute.md#ParseCsvLine)
