...
| ID | 기능 | 트리거 | 유형 | 문서 |
|---|---|---|---|---|
| BOM-001 | VIZCore3D 초기화 완료 | Vizcore3d_OnInitializedVIZCore3D | Event Callback | [vizcore3d-initialized](./VIZCore3D 초기화.md) |
| BOM-002 | 모델 파일 열기 | btnOpen_Click | User Action | [open-model](./모델 열기.md) |
| BOM-003 | BOM 수집 (홀 감지 포함) | btnCollectBOM_Click | User Action | [collect-bom](./BOM 수집.md) |
| BOM-004 | 메인 체인 치수 계산 | btnMainDimension_Click | User Action | [main-dimension](./메인 치수 추출.md) |
