...
| # | 단계 | 주체 | 설명 |
|---|---|---|---|
| 1 | 라이선스 초기화 | Form1.License | `InitializeLicense()` 위임 — `License.LicenseServer("127.0.0.1", 8901)` + 실패 시 MessageBox·return, 성공 시 30분 갱신 타이머 시작 (→ [E01], [Form1.License.cs](../../code-reference/form1-license.md)) |
...
> 구현 상세는 [코드 레퍼런스](../../code-reference/form1-bom.md#vizcore3d-oninitialized) 참고
...
- 라이선스 전담: [Form1.License.cs](../../code-reference/form1-license.md)
