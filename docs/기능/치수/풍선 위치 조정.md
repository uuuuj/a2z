...
> 구현 상세는 [코드 레퍼런스](../../code-reference/form1-dimensions.md#btnBalloonAdjust_Click) 참고
...
## 8. 후행 기능 (Chained)
- [PDF 내보내기](../2D도면/PDF%20출력.md) — 조정된 위치 반영

## 9. 관련 링크
- 코드 구현: [Form1.Dimensions.cs:L238](../../code-reference/form1-dimensions.md#btnBalloonAdjust_Click)
