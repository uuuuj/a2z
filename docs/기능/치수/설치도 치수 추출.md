...
> 구현 상세는 [코드 레퍼런스](../../code-reference/form1-dimensions.md#btnExtractDimension_Click) 참고
...
- [설치도 치수 추출](../글로벌뷰/_인덱스.md)

## 9. 관련 링크
- 코드 구현: [Form1.Dimensions.cs:L1735](../../code-reference/form1-dimensions.md#btnExtractDimension_Click)
