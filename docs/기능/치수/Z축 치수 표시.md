...
Hole, SlotHole, EarthBoss 형상 풍선은 가공도 전용이므로 Z축 뷰에는 표시하지 않는다.

## 8. 후행 기능 (Chained)
- 다른 축/ISO 뷰

## 9. 관련 링크
- 코드 구현: [Form1.Dimensions.cs:L222](../../code-reference/form1-dimensions.md#btnShowAxisZ_Click)
