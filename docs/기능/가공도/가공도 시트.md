...
엑셀 템플릿을 가져온 직후 `RemoveEmptyTemplateBorders`(SDK 1.0.26.716, tol 0.1f·RowAndColumn)가 내용 없는 공백 셀(미기재 BOM 행 등)의 괘선을 지운다 — 제작도와 동일 패턴 (2026-07-21). 전역 동작이라 개정 이력 표 등 비워두는 Input 칸(164~194)은 공백(`" "`)으로 채워 보호하고, BOM(4~163)·부재명(195~199) 슬롯만 빈칸으로 둬 미기재 행·빈 밴드가 제거되게 한다.
