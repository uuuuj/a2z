...
- `ExecuteMfgDrawing`: 도면번호 리스트 클릭 시 3D 미리보기(부재 격리·카메라·회전·FlyToObject3d fit). 화면축 회전은 상대(누적)라 진입부에서 직전 회전을 원복(`_mfgPreviewNetRoll`) 후 이번 회전을 1회만 적용 (2026-07-22 fit 수정)
