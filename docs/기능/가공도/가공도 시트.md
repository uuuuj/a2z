...
엑셀 템플릿을 가져온 직후 `RemoveEmptyTemplateBorders`가 내용 없는 공백 셀(미기재 BOM 행 등)의 괘선을 지운다. 전역 동작이라 남길 칸(PAINT/DP/TAG 165~169·Rev 첫 기재행 REV. 칸 194)만 공백(`" "`)으로 위장 보호하고, BOM(1~20행=4~163·21~25행=201~240)·Note(164)·Rev 위 4행(170~193)·부재명(195~199)은 빈칸으로 둬 괘선이 제거되게 한다.
