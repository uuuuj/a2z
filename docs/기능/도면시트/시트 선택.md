...
| 5 | 전체 부재 Hide | SDK | `Object3DKind.ALL`을 숨겨 이전 설치도의 외부 연결 Part 잔존까지 제거 |
| 6 | 시트 표시 대상 Show | SDK | 일반 시트는 `MemberIndices`, 설치도는 `MemberIndices + InstallationContextIndices` |
| 7 | 실루엣 유지 | SDK | Green |
