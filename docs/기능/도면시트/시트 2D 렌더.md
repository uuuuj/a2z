...
|---|---|---|
| `GM11` | `{View_5}` | `North_Arrow.png` |
| `GW167` | `{View_6}` | CLIENT 로고 예약 (현재 이미지 미지정) |
| `U11` | `{View_7}` | `ISO_North_Arrow.png` |
| `GW182` | `{Image}` | CONTRACTOR 로고 — `Logo.png`를 `Set2DViewTemplateMark`로 등록 후 Import 시 치환 (미등록이면 태그 글자 노출) |
