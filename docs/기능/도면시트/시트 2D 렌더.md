...
| 14 | 3D 임시 치수 정리 | Form1 | `finally`에서 `Review.Measure`·`ShapeDrawing` 제거. 이미 복사된 2D 치수는 유지 |
...
## 9. 관련 링크
- 코드 구현: [Form1.DrawingSheets.cs:L1094](../../code-reference/form1-drawing-sheets.md#btnGenerateSheet2D_Click)
