...
## 1. 개요
선택 시트를 X축 방향(YZ 평면)으로 보여주고 치수를 표시한다. 설치도는 선택 STRU와 직접 연결된 외부 Assembly 전체를 함께 표시하고 Z 주축·Y 보조축 설치 치수를 사용한다.
...
## 9. 관련 링크
- 코드 구현: [Form1.DrawingSheets.cs:L760](../../code-reference/form1-drawing-sheets.md#btnDrawingAxisX_Click)
