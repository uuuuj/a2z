    ...
    public partial class Form1
    {
            ...
            DrawingReferenceFrame drawingReferenceFrame = null)
        {
            ...
            try
            {
                ...
                // (2026-08-23 죽은 코드 제거) 풍선 통합 배치 블록 약 270줄 삭제.
                //   balloonEntries가 선언 직후 Clear()된 채 소비돼 실행 0회였다 (2026-07-22 수집부
                //   삭제 때 소비부가 남은 것). 형상 풍선은 가공도 전용(BuildMfgPendingNotes),
                //   ISO 부재번호 풍선은 CreateIsoBalloonNotes 별도 경로.
                //   근거: docs/코드분석/판정/죽은 코드.md #1
